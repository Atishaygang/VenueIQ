...
export default function VoiceControlBar({ isMobile }) {
  ...
  return (
    <button
      ...
      className={`fixed top-4 ${isMobile ? 'right-16' : 'right-4'} z-[100] bg-[#1a1a24] text-white p-2 rounded-full shadow-lg border border-gray-700 hover:bg-[#2a2a35] transition-colors`}
    >
